...
```sh
$ cd ~/githubrepo/ktds-edu2/kafka/strimzi
...
export PASSWORD=PkcAIUblNHFg        ## 개인별 passwrod 붙여넣자.   위 3.2 KafkaUser 를 참고하자. 
...
Spring 에서 Kafka 를 사용하는 방법에는 여러가지가 있지만 본 실습에서는 Spring Cloud Stream 를 이용할 것이다.

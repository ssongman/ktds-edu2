...
$ tar -xzvf strimzi-0.34.0.tar.gz

$ cd ~/song/strimzi/strimzi-0.34.0/
```
...
# 1) operator RoleBindings
$ 
kubectl -n kafka create -f install/cluster-operator/020-RoleBinding-strimzi-cluster-operator.yaml
kubectl -n kafka create -f install/cluster-operator/023-RoleBinding-strimzi-cluster-operator.yaml
...
strimzi-cluster-operator-7b7d6f76d9-lfcg8   1/1     Running   0          31s




# operator pod log 확인
$ kubectl -n kafka logs -f strimzi-cluster-operator-7b7d6f76d9-lfcg8

2023-03-27 14:29:07 INFO  ClusterOperator:124 - Opened watch for Kafka operator
2023-03-27 14:29:07 INFO  ClusterOperator:124 - Opened watch for KafkaMirrorMaker operator
2023-03-27 14:29:07 INFO  ClusterOperator:124 - Opened watch for KafkaConnect operator
2023-03-27 14:29:07 INFO  ClusterOperator:124 - Opened watch for KafkaBridge operator
2023-03-27 14:29:07 INFO  ClusterOperator:124 - Opened watch for KafkaMirrorMaker2 operator
2023-03-27 14:29:07 INFO  ClusterOperator:136 - Setting up periodic reconciliation for namespace kafka
2023-03-27 14:29:07 INFO  Main:208 - Cluster Operator verticle started in namespace kafka without label selector




# clean up
$ kubectl -n kafka delete -f install/cluster-operator/020-RoleBinding-strimzi-cluster-operator.yaml
$ kubectl -n kafka delete -f install/cluster-operator/023-RoleBinding-strimzi-cluster-operator.yaml
$ kubectl -n kafka delete -f install/cluster-operator/031-RoleBinding-strimzi-cluster-operator-entity-operator-delegation.yaml
...
NAME      TYPE     DATA   AGE
my-user   Opaque   2      2m6s



$ kubectl -n kafka get secret my-user -o jsonpath='{.data.password}' | base64 -d
vLr2YrZPgqDNtp9i7fRZICrVRR2ifEWu


# user/pass 
## 강사님 기준 : my-user / vLr2YrZPgqDNtp9i7fRZICrVRR2ifEWu
## 수강생 기준 : my-user / ______        <-- 여기에 Password 를 기록하세요.
...
export PASSWORD=vLr2YrZPgqDNtp9i7fRZICrVRR2ifEWu        ## 개인별 passwrod 붙여넣자.   위 3.2 KafkaUser 를 참고하자. 
...
Metadata for all topics (from broker -1: sasl_plaintext://my-cluster-kafka-bootstrap:9092/bootstrap):
 ...
 1 topics:
  topic "my-topic" with 3 partitions:
    partition 0, leader 2, replicas: 0,2,1, isrs: 1,2,0
    partition 1, leader 1, replicas: 2,1,0, isrs: 1,2,0
    partition 2, leader 1, replicas: 1,0,2, isrs: 1,2,0
...
topic : my-topic
user : my-user
pass : vLr2YrZPgqDNtp9i7fRZICrVRR2ifEWu
...
```
-----BEGIN CERTIFICATE-----

fvIpvXhaNrwDxYYzZ4PWefI2zqKXTttWuUPhdaeeMFkw
-----END CERTIFICATE-----
...
sasl_user='my-user'
sasl_password='vLr2YrZPgqDNtp9i7fRZICrVRR2ifEWu'
...
consumer = KafkaConsumer(bootstrap_servers=bootstrap_servers,
                        ...
                        enable_auto_commit=True,
                        group_id='my-topic-group',
                        ssl_cafile='/root/song/ca.crt')


ssl.SSLError: [SSL: SSLV3_ALERT_BAD_CERTIFICATE] sslv3 alert bad certificate (_ssl.c:2633)
